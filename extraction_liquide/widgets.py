# -*- coding: utf-8 -*-
"""
Created on Wed May 20 13:20:25 2026

@author: maxim
"""

""" Programmes pour cr̩er des widgets
Une class Widget (et FloatSlider, IntSlider) qui permet
d'enregistrer des param̬tres avant de cr̩er le widget. La 
syntaxe est la m̻me que les ipywidgets. Ceci permet entre
autre de mettre de s̩parer le fond (les parm̬tres) de la forme
...
def make_param_widgets(parameters, plot_data, slider_box):
    """ Cr̩e automatiquement les widget matplotlib
