...
# Frontière verticale
ax1.axvline(pNH3_front_vert, ymin = (E_front1_theory-0.2)/(1.4-0.2), color='purple',
...
ax2.axhline(E_front1_theory,
            xmin=(pNH3_front_vert / 7), color='navy', linewidth=1, linestyle=':',
...
ax2.axvline(pNH3_front_vert, ymin = (E_front1_theory-0.2)/(1.4-0.2), 
