...
# k1 and k2 are on/off switch that allow to describe either fast or slow charge kinetic transferts
#################
### Functions ###
#################
...
#i-E for Fe data at the added volume V:
...
#i-E for Ce data at the added volume V:
...
#Titration spot
#We look for a value of a potential for which i = 0 ; E and i are defined as lists
...
def plot_data(V,k1,k2):
    ...
    spot_list_E.append(titration_spot(V,k1,k2))
    ...
    lines_2['$Titration \ spot \ (left)$'].set_data(titration_spot(V,k1,k2),0)
    lines_2['$Titration \ spot \ (right)$'].set_data(V,titration_spot(V,k1,k2))
...
lines_2={}
#Display of the mesured potential o both curves
lines_2['$Titration \ spot \ (left)$'], = ax1.plot([], [],'o',color='black',lw=2,label='$Titration \ spot$')
